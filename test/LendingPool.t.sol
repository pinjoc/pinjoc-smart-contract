...
contract LendingPoolBaseTest is Test {
    ...
    function setUp_DebtSupply() public {
        vm.prank(lender);
        IERC20(usdc).transfer(address(lendingPool), lenderDefaultBalance);
    ...
    function setUp_CollateralSupply() public {
        ...
        lendingPool.supplyCollateral(borrower, borrowerDefaultBalance);
    }
...
contract LendingPoolBorrowTest is LendingPoolBaseTest {
    ...
    function test_Borrow() public {
        ...
        assertEq(lendingPool.totalBorrowAssets(), 1000e6);
    }
